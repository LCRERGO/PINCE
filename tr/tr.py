...
class TranslationConstants(QObject):
    ...
    NEXT_SCAN = QT_TR_NOOP("Next Scan")
    CANCEL_SCAN = QT_TR_NOOP("Cancel Scan")
    UNDO_SCAN = QT_TR_NOOP("Undo Scan")
    HEX = QT_TR_NOOP("Hex")
    SCAN_TYPE_LABEL = QT_TR_NOOP("Scan Type:")
    VALUE_TYPE_LABEL = QT_TR_NOOP("Value Type:")
    SCAN_SCOPE_LABEL = QT_TR_NOOP("Scan Scope:")
    ENDIANNESS_LABEL = QT_TR_NOOP("Endianness:")
    ALIGNMENT_LABEL = QT_TR_NOOP("Alignment:")
    MANAGE_SCAN_REGIONS = QT_TR_NOOP("Manage Scan Regions")
    SCAN_RESULT_ADDRESS = QT_TR_NOOP("Address")
    SCAN_RESULT_VALUE = QT_TR_NOOP("Value")
    SCAN_RESULT_PREVIOUS = QT_TR_NOOP("Previous")
    SCAN_TAB_TITLE = QT_TR_NOOP("Scan {}")
    ADD_SCAN_TAB = QT_TR_NOOP("Add a new scan tab")
    RENAME_TAB_TITLE = QT_TR_NOOP("Rename tab")
    ENTER_TAB_NAME = QT_TR_NOOP("Enter the new tab name")
