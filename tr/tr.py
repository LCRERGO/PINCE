...
class TranslationConstants(QObject):
    ...
    TYPES = QT_TR_NOOP("Types")
    NEW_TYPE = QT_TR_NOOP("New type")
    EDIT_TYPE = QT_TR_NOOP("Edit type")
    TYPE_NAME = QT_TR_NOOP("Name")
    TYPE_NAME_TAKEN = QT_TR_NOOP("A type with this name already exists")
    TYPE_NAME_EMPTY = QT_TR_NOOP("Type name cannot be empty")
    TYPE_KIND = QT_TR_NOOP("Kind")
    TYPE_KIND_ALIAS = QT_TR_NOOP("Alias")
    TYPE_KIND_ENUM = QT_TR_NOOP("Enum")
    TYPE_UNDERLYING = QT_TR_NOOP("Underlying type")
    TYPE_ENUM_VALUES = QT_TR_NOOP("Values")
    TYPE_ENUM_LABEL = QT_TR_NOOP("Label")
    TYPE_ENUM_VALUE = QT_TR_NOOP("Value")
    TYPE_ADD_VALUE = QT_TR_NOOP("Add")
    TYPE_REMOVE_VALUE = QT_TR_NOOP("Remove")
    DELETE_TYPE = QT_TR_NOOP("Delete type")
    DELETE_TYPE_PROMPT = QT_TR_NOOP("Delete type '{}'?")
    TYPE_IN_USE = QT_TR_NOOP("'{}' is still used by:\n{}")
    TYPE_SELECT = QT_TR_NOOP("Select a type")
